...
public class HashTest
{
    ...
    public void TestSha2()
    {
        ...
        for (var length = 0; length < 1_000; length++)
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                ...
                h2 = Sha2Helper.Get256ByteArray(buffer);
                h.SequenceEqual(h2).IsTrue();
            }

            h = sha2.GetHash(buffer, 0, length);

            var h3 = Sha2Helper.Get256UInt64(buffer);
            var b = h4.AsSpan();
            ...
            Sha2Helper.Get256Span(buffer, h4);
            h.SequenceEqual(h4).IsTrue();
        }
    }
    ...
    public void TestSha3()
    {
        ...
        Sha3Helper.Get256ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get256ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get256ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get256ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get384ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get384ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get384ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get384ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get512ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get512ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get512ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Helper.Get512ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
    }

...
public class HashTest
{
    ...
    public void TestSha3()
    {
        ...
        Sha3Struct.Get256_ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get256_ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get256_ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get256_ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get384_ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get384_ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get384_ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get384_ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get512_ByteArray(utf8_empty).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get512_ByteArray(utf8_abc).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get512_ByteArray(utf8_alphabet).SequenceEqual(hash).IsTrue();
        ...
        Sha3Struct.Get512_ByteArray(utf8_million).SequenceEqual(hash).IsTrue();
    }

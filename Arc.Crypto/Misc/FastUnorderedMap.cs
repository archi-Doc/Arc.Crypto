...
/*public interface IKeyLookup<TKey>
{// Extension Interface required...
}

/// <summary>
/// Represents a collection of objects. <see cref="FastUnorderedMap{TKey, TValue}"/> uses a hash table structure to store objects.
/// </summary>
/// <typeparam name="TKey">The type of keys in the collection.</typeparam>
/// <typeparam name="TValue">The type of values in the collection.</typeparam>
public class FastUnorderedMap<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary
{
    public struct Node
    {
...
#pragma warning restore SA1307 // Accessible fields should begin with upper-case letter
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FastUnorderedMap{TKey, TValue}"/> class.
    /// </summary>
    public FastUnorderedMap()
        : this(0, null)
    {
    }
    ...
    public FastUnorderedMap(int capacity)
        : this(capacity, null)
    {
    }
    ...
    public FastUnorderedMap(IEqualityComparer<TKey> comparer)
        : this(0, comparer)
    {
    }
    ...
    /// <param name="capacity">The initial number of elements that the collection can contain.</param>
    /// <param name="comparer">The default comparer to use for comparing objects.</param>
    public FastUnorderedMap(int capacity, IEqualityComparer<TKey>? comparer)
    {
    ...
    public FastUnorderedMap(IDictionary<TKey, TValue> dictionary)
    ...
    /// <param name="dictionary">The IDictionary implementation to copy to a new collection.</param>
    /// <param name="comparer">The default comparer to use for comparing objects.</param>
    public FastUnorderedMap(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
    ...
    public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IDictionaryEnumerator
    {
        ...
        private readonly FastUnorderedMap<TKey, TValue> map;
        ...
        internal Enumerator(FastUnorderedMap<TKey, TValue> map, int getEnumeratorRetType)
        {
            this.map = map;
    ...
    public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
    {
        ...
        public KeyCollection(FastUnorderedMap<TKey, TValue> map)
        {
            if (map == null)
            {
        ...
        public struct Enumerator : IEnumerator<TKey>, IEnumerator
        {
            ...
            internal Enumerator(FastUnorderedMap<TKey, TValue> map)
            {
    ...
    public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
    {
        ...
        public ValueCollection(FastUnorderedMap<TKey, TValue> map)
        {
            if (map == null)
            {
                throw new ArgumentNullException(nameof(map));
    ...
    /// <summary>
    /// Gets the number of nodes actually contained in the <see cref="FastUnorderedMap{TKey, TValue}"/>.
    /// </summary>
...
#pragma warning restore CS8767 // Nullability of reference types in type of parameter doesn't match implicitly implemented member (possibly because of nullability attributes).
    ...
    /// <summary>
    /// Searches for the first <see cref="FastUnorderedMap{TKey, TValue}.Node"/> index with the specified key.
    /// </summary>
    ...
    /// <summary>
    /// Searches for the first <see cref="FastUnorderedMap{TKey, TValue}.Node"/> index with the specified key and value.
    /// </summary>
    /// <param name="key">The key to search in a collection.</param>
    ...
    /// <summary>
    /// Enumerates <see cref="FastUnorderedMap{TKey, TValue}.Node"/> indexes with the specified key.
    /// </summary>
    /// <param name="key">The key to search in a collection.</param>
    ...
    /// <summary>
    /// Enumerates <see cref="FastUnorderedMap{TKey, TValue}.Node"/> values with the specified key.
    /// </summary>
    /// <param name="key">The key to search in a collection.</param>
    ...
    /// <returns>NodeIndex: the added <see cref="FastUnorderedMap{TKey, TValue}.Node"/>.<br/>
    ...
    /// <br/>O(1) operation.
    /// </summary>
    /// <param name="nodeIndex">The <see cref="FastUnorderedMap{TKey, TValue}.Node"/> to set the key.</param>
    ...
    /// <br/>O(1) operation.
    /// </summary>
    /// <param name="nodeIndex">The <see cref="FastUnorderedMap{TKey, TValue}.Node"/> to set the value.</param>
    ...
    /// <br/>O(1) operation.
    /// </summary>
    /// <param name="nodeIndex">The <see cref="FastUnorderedMap{TKey, TValue}.Node"/> to remove.</param>

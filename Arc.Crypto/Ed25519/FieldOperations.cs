...
internal static class FieldOperations
{
    ...
    public static unsafe void fe_mul(out FieldElement h, ref FieldElement f, ref FieldElement g)
    {
        ...
        var f2g6 = f2 * (long)g6;
        var f2g7 = f2 * (long)g7;
        var f2g8_19 = f2 * (long)vec_g19[7]; // g8_19;
        ...
        var f3g8_19 = f3 * (long)vec_g19[7]; //  g8_19;
        ...
        var f4g4 = f4 * (long)g4;
        var f4g5 = f4 * (long)g5;
        var f4g6_19 = f4 * (long)vec_g19[5]; // g6_19;
        var f4g7_19 = f4 * (long)vec_g19[6]; // g7_19;
        var f4g8_19 = f4 * (long)vec_g19[7]; // g8_19;
        ...
        var f5g6_19 = f5 * (long)vec_g19[5]; // g6_19;
        var f5g7_38 = f5_2 * (long)vec_g19[6]; // g7_19;
        var f5g8_19 = f5 * (long)vec_g19[7]; // g8_19;
        var f5g9_38 = f5_2 * (long)g9_19;
        var f6g0 = f6 * (long)g0;
        var f6g1 = f6 * (long)g1;
        var f6g2 = f6 * (long)g2;
        var f6g3 = f6 * (long)g3;
        var f6g4_19 = f6 * (long)vec_g19[3]; // g4_19;
        var f6g5_19 = f6 * (long)vec_g19[4]; // g5_19;
        var f6g6_19 = f6 * (long)vec_g19[5]; // g6_19;
        var f6g7_19 = f6 * (long)vec_g19[6]; // g7_19;
        var f6g8_19 = f6 * (long)vec_g19[7]; // g8_19;
        var f6g9_19 = f6 * (long)g9_19;
        var f7g0 = f7 * (long)g0;
        var f7g1_2 = f7_2 * (long)g1;
        var f7g2 = f7 * (long)g2;
        var f7g3_38 = f7_2 * (long)vec_g19[2]; // g3_19;
        var f7g4_19 = f7 * (long)vec_g19[3]; // g4_19;
        var f7g5_38 = f7_2 * (long)vec_g19[4]; // g5_19;
        var f7g6_19 = f7 * (long)vec_g19[5]; // g6_19;
        var f7g7_38 = f7_2 * (long)vec_g19[6]; // g7_19;
        var f7g8_19 = f7 * (long)vec_g19[7]; // g8_19;
        var f7g9_38 = f7_2 * (long)g9_19;
        var f8g0 = f8 * (long)g0;
        var f8g1 = f8 * (long)g1;
        var f8g2_19 = f8 * (long)vec_g19[1]; // g2_19;
        var f8g3_19 = f8 * (long)vec_g19[2]; // g3_19;
        var f8g4_19 = f8 * (long)vec_g19[3]; // g4_19;
        var f8g5_19 = f8 * (long)vec_g19[4]; // g5_19;
        var f8g6_19 = f8 * (long)vec_g19[5]; // g6_19;
        var f8g7_19 = f8 * (long)vec_g19[6]; // g7_19;
        var f8g8_19 = f8 * (long)vec_g19[7]; // g8_19;
        var f8g9_19 = f8 * (long)g9_19;
        var f9g0 = f9 * (long)g0;
        var f9g1_38 = f9_2 * (long)vec_g19[0]; // g1_19;
        var f9g2_19 = f9 * (long)vec_g19[1]; // g2_19;
        var f9g3_38 = f9_2 * (long)vec_g19[2]; // g3_19;
        var f9g4_19 = f9 * (long)vec_g19[3]; // g4_19;
        var f9g5_38 = f9_2 * (long)vec_g19[4]; // g5_19;
        var f9g6_19 = f9 * (long)vec_g19[5]; // g6_19;
        var f9g7_38 = f9_2 * (long)vec_g19[6]; // g7_19;
        var f9g8_19 = f9 * (long)vec_g19[7]; // g8_19;
